            ...
            <div class="panel-body">
                <form action="{{route('admin.supplies.store')}}" method="POST" id="frm-add" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" value="{{isset($supply->phone) ? $supply->phone : ''}}" >
                    </div>
                    <div class="form-group">
                        <label>{{trans('title.address')}}</label>
                        <input type="text" name="address" class="form-control" value="{{isset($supply->address) ? $supply->address : ''}}" >
                    </div>
