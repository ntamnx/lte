<form action="{{route('admin.supplies.store')}}" method="POST" id="frm-add-cutomer" enctype="multipart/form-data">
...
@section('js')
{!! JsValidator::make(App\Entities\Supply::$rules,[],[],'#frm-add-cutomer') !!}
@endsection